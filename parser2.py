...
#Html init
	textfile.write("<!DOCTYPE html><html><head><link type=\"text/css\" rel=\"stylesheet\" href=\"stylesheet.css\"/><title>GooD'ay</title></head><body>")
...
#City input form
	textfile.write('<form>User 1: <input type="text" name="name1"><br><input type="submit" value="Submit"></form>')
	textfile.write("</p>")
